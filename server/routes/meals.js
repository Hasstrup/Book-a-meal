...
router.put('/:mealId', BaseMiddleware.checkForNullInput, BaseMiddleware.__checkParams, BaseMiddleware.checkAuthorization, MealMiddleware.__filterAccess, MealMiddleware.__ensureKitchenOwner, MealMiddleware.__revokeAccess, MealController.updateContent, ErrorHandler.dispatch);

/* check the request for the kitchen query, reject request
if null or it doesnt match the owner of the item */
router.delete('/:mealId', BaseMiddleware.checkAuthorization,  BaseMiddleware.__checkParams, MealMiddleware.__filterAccess, MealMiddleware.__ensureKitchenOwner, MealMiddleware.__revokeAccess, MealController.deleteContent, ErrorHandler.dispatch);
