...
class KitchenControllerBase extends BaseController {
    ...
    fetchSingle = (req, res, next) => {
      this.wrapInTryCatch(async () => {
        data = req.populate ? await KitchenModule.fetchOne('id', req.params.ktid, 'populate')(req.paginationQuery) : await KitchenModule.fetchOne('id', req.params.ktid, false)(req.paginationQuery);
        this.returnContent(res, data);
      }, next);
    }
