...
var OrderControllerBase = function (_BaseController) {
  _inherits(OrderControllerBase, _BaseController);

  function OrderControllerBase() {
    var _ref,
        _this2 = this;

    var _temp, _this, _ret;

    _classCallCheck(this, OrderControllerBase);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = OrderControllerBase.__proto__ || Object.getPrototypeOf(OrderControllerBase)).call.apply(_ref, [this].concat(args))), _this), _this.create = function (req, res, next) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _orders2.default.__create(req.user.id, req.body);
  ...
  return OrderControllerBase;
}(_baseController2.default);

var OrdersController = new OrderControllerBase();
