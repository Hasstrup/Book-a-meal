...
// api versioning;
.use(_express2.default.static('public/dist')).use('/api/v1', _api2.default).get('/*', function (_, res) {
  return res.sendFile(_path2.default.join(__dirname + '/public/dist/index.html'));
